...
次に、[LTEPi for D](https://www.candy-line.io/製品一覧/ltepi-for-d/)をRaspberry Piに設置します。また、付属のアンテナを2本ともモジュールに接続します。続けて、SIMカードを差し込みます。SIMカードは、金属面を下向きにして取り付けます。

最後に、付属のUSBケーブルで[LTEPi for D](https://www.candy-line.io/製品一覧/ltepi-for-d/)とRaspberry Piを接続します。
